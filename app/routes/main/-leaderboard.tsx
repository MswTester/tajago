...
export default function LeaderboardState(props:socketProps){
    ...
    useEffect(() => {
        if(homeState !== 'leaderboard' && mainRef.current) mainRef.current.style.animation = 'page-down 0.3s ease-in-out'
    }, [homeState])
